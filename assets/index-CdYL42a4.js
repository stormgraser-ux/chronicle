...
`)}function $(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function j(){return`
  ...
  `}function x(){const e=g.layers;return`
    <section class="section" id="system">
      ...
      <div class="arch-screenshot reveal">
        <img
          src="${p}screenshots/architecture-multi-claude-terminals.png"
      ...
      <div class="terminal-block reveal">
        ...
        <pre class="terminal-body"><code>${k($(b))}</code></pre>
      </div>
  ...
  `}function S(e){return`
    <div class="arch-layer reveal" data-layer="${e.id}">
      ...
      <div class="persona-grid">
        ${e.list.map(a=>{const o=u.find(s=>s.persona.name===a.name),t=o?o.id:"";return`
  ...
  `}function P(e){const a=e.screenshots.length>0,o=a?e.screenshots[0]:null,t=a?e.screenshots.slice(1):[];return`
  ...
  `}function I(){return`
    <footer class="footer">
      <div class="footer-mobile reveal">
        <img
          src="${p}screenshots/mobile-claude-termius.jpg"
  ...
  `}function D(){const e=m("#app");e.innerHTML=`
    ${j()}
    <main class="main">
      ${C()}
      ${x()}
  ...
  `,A(),O(),B(),G(),F(),H()}function A(){const e=new IntersectionObserver(o=>{o.forEach(t=>{if(t.isIntersecting){const s=t.target.style.getPropertyValue("--delay")||"0ms";t.target.style.transitionDelay=s,t.target.classList.add("revealed"),e.unobserve(t.target)}})},{threshold:.08,rootMargin:"0px 0px -40px 0px"});v(".reveal").forEach(o=>e.observe(o));const a=m(".persona-grid");if(a){const o=new IntersectionObserver(t=>{t.forEach(s=>{s.isIntersecting&&(s.target.querySelectorAll(".persona-chip").forEach((i,c)=>{setTimeout(()=>i.classList.add("shimmer"),c*100)}),o.unobserve(s.target))})},{threshold:.3});o.observe(a)}}function O(){document.addEventListener("click",e=>{const a=e.target.closest(".clickable-img");if(!a)return;const o=a.src,t=a.dataset.caption||"",s=a.dataset.gallery,n=parseInt(a.dataset.index??-1);let i=[{src:o,caption:t}];if(s){const c=u.find(l=>l.id===s);c&&(i=c.screenshots.map(l=>({src:`${p}screenshots/${l.src}`,caption:l.caption})))}R(i,n>=0?n:0)})}function R(e,a){let o=a;const t=document.createElement("div");t.className="lightbox";function s(){const r=e[o],d=e.length>1;t.innerHTML=`
    ...
    `}s(),document.body.appendChild(t),document.body.style.overflow="hidden",requestAnimationFrame(()=>t.classList.add("lightbox-open"));function n(){t.classList.remove("lightbox-open"),document.body.style.overflow="",setTimeout(()=>t.remove(),250)}t.addEventListener("click",r=>{r.target.closest(".lightbox-prev")&&o>0?(o--,s()):r.target.closest(".lightbox-next")&&o<e.length-1?(o++,s()):(r.target.closest(".lightbox-close")||r.target.closest(".lightbox-backdrop"))&&n()});let i=0;t.addEventListener("touchstart",r=>{i=r.touches[0].clientX},{passive:!0}),t.addEventListener("touchend",r=>{const d=r.changedTouches[0].clientX-i;Math.abs(d)>60&&(d>0&&o>0?(o--,s()):d<0&&o<e.length-1&&(o++,s()))},{passive:!0});function c(r){r.key==="Escape"&&n(),r.key==="ArrowLeft"&&o>0&&(o--,s()),r.key==="ArrowRight"&&o<e.length-1&&(o++,s())}document.addEventListener("keydown",c),t.addEventListener("remove",()=>document.removeEventListener("keydown",c));const l=new MutationObserver(()=>{document.body.contains(t)||(document.removeEventListener("keydown",c),l.disconnect())});l.observe(document.body,{childList:!0})}function B(){const e=["system","projects","journey"],a=v(".nav-link"),o=new IntersectionObserver(n=>{n.forEach(i=>{if(i.isIntersecting){const c=i.target.id;a.forEach(l=>{l.classList.toggle("active",l.dataset.section===c)})}})},{threshold:0,rootMargin:"-30% 0px -60% 0px"});e.forEach(n=>{const i=document.getElementById(n);i&&o.observe(i)});let t=0;const s=m("#nav");window.addEventListener("scroll",()=>{const n=window.scrollY;s.classList.toggle("nav-scrolled",n>80),n>400?s.classList.toggle("nav-hidden",n>t&&n-t>5):s.classList.remove("nav-hidden"),t=n},{passive:!0})}function G(){document.addEventListener("click",e=>{const a=e.target.closest('a[href^="#"]');if(!a)return;e.preventDefault();const o=document.querySelector(a.getAttribute("href"));o&&o.scrollIntoView({behavior:"smooth",block:"start"})})}function F(){document.addEventListener("click",e=>{if(e.target.closest(".clickable-img"))return;const a=e.target.closest(".project-card-preview");if(!a)return;const o=a.closest(".project-card");o&&f(o)})}function f(e,a=!1){const o=e.classList.contains("expanded");if(a&&o)return;const t=e.querySelector(".project-card-details");if(t)if(o&&!a)t.style.maxHeight=t.scrollHeight+"px",requestAnimationFrame(()=>{t.style.maxHeight="0px"}),e.classList.remove("expanded");else{e.classList.add("expanded"),t.style.maxHeight=t.scrollHeight+"px";const s=()=>{t.style.maxHeight="none",t.removeEventListener("transitionend",s)};t.addEventListener("transitionend",s)}}function H(){document.addEventListener("click",e=>{const a=e.target.closest("[data-goto-project]");if(!a)return;const o=a.dataset.gotoProject,t=document.getElementById(`project-${o}`);t&&(t.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{f(t,!0),t.classList.add("highlight-pulse"),setTimeout(()=>t.classList.remove("highlight-pulse"),800)},400))})}D();
